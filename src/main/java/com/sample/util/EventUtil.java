...
public class EventUtil {
    public static GenericRecord deserialize(Schema schema, ProducerEvent producerEvent) throws IOException {
        DatumReader<GenericRecord> reader = new GenericDatumReader<GenericRecord>(schema);
        ByteArrayInputStream in = new ByteArrayInputStream(producerEvent.getPayload().toByteArray());
     ...
     * @throws IOException
     */
    public static List<String> getFieldListFromBitmap(Schema schema, GenericData.Record eventHeader, String fieldName)
            throws IOException {
        GenericData.Array<Utf8> utf8Values = (GenericData.Array<Utf8>) eventHeader.get(fieldName);
    ...
    private static Schema getValueSchema(Schema schema) {
        if (schema.getType() == Schema.Type.UNION) {
            ...
            } else if (types.size() == 3 && types.get(0).getType() == Schema.Type.NULL
                    && types.get(1).getType() == Schema.Type.STRING) {
